...
def plot_frame(df, frame=1, view_home=True, view_away=True, view_ball=True):
    ...
    semi1 = Arc((4042.5, 0), width=1830, height=1830, theta1=90+theta,
                theta2=270-theta, fill=0)
    semi2 = Arc((-4042.5, 0), width=1830, height=1830, theta1=270+theta,
                theta2=90-theta, fill=0)
    ...
    plt.title('Ball possession: {}, ball in play: {}'.format(
        df[df.utc == df.utc[frame]].ballPossession.iloc[0],
